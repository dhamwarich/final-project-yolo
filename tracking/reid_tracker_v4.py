"""
Module: Re-ID Tracker V4 (Color-Region Refined)
Refined tracking with LAB shirt/pants histograms, no torso-leg ratio.
"""
...
class TrackV4:
    """Track with LAB shirt/pants histograms, no torso-leg."""
    ...
    def __init__(self, track_id: int, detection: Dict):
        ...
        # Geometric features (NO torso_leg, NO height)
        ...
        # LAB-based appearance (shirt/pants separation)
    ...
    def update(self, detection: Dict, alpha: float = 0.2):
        ...
        # Update LAB histogram-based appearance with EMA
...
class ReIDTrackerV4:
    """Color-region refined Re-ID tracker (LAB shirt/pants, no torso-leg)."""
    ...
    def compute_cost_matrix(
        ...
        """
        Compute cost matrix with LAB shirt/pants separation.
        ...
        NO torso_leg, NO height.
        
        Args:
            detections: List of detection dictionaries
            tracks: List of TrackV4 objects
        ...
        for i, det in enumerate(detections):
            for j, track in enumerate(tracks):
                ...
                # Weighted fusion (Week 5 weights)
                cost = (
                    0.25 * sh_diff +
                    0.15 * aspect_diff +
                    0.35 * shirt_dist +
    ...
    def update(self, detections: List[Dict]) -> List[Dict]:
        ...
        for det_idx in unmatched_dets:
            ...
            if memory_id is not None:
                ...
                new_track = TrackV4(memory_id, detections[det_idx])
        ...
        for det_idx in remaining_dets:
            new_track = TrackV4(self.next_id, detections[det_idx])
            self.tracks.append(new_track)
            self.next_id += 1
